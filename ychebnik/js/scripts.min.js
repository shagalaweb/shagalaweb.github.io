...
$(function(){$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")}),$("#my-menu").mmenu({navbar:{title:"Учебник"}}),$("#my-menu").data("mmenu").bind("open:start",function(){$(".hamburger").addClass("is-active")}).bind("close:finish",function(){$(".hamburger").removeClass("is-active")})});